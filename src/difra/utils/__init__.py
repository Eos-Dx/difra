"""DiFRA utilities package.

Logging utilities for the DiFRA application. Use setup_logging() or
...
then use either the stdlib "logging" or difra.utils.logger helpers.
