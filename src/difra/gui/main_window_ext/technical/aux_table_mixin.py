...
from difra.gui.main_window_ext.technical.aux_table_recovery_mixin import (
    TechnicalAuxTableRecoveryMixin,
)
from difra.gui.main_window_ext.technical.aux_table_state_mixin import (
    TechnicalAuxTableStateMixin,
)
...
class TechnicalAuxTableMixin(TechnicalAuxTableRecoveryMixin, TechnicalAuxTableStateMixin):
    @staticmethod
