...
from difra.gui.main_window_ext.technical.h5_generation_fake_poni_mixin import (
    H5GenerationFakePoniMixin,
)
...
class H5GenerationMetaMixin(H5GenerationFakePoniMixin):
    @staticmethod
