...
from difra.gui.main_window_ext.zone_measurements.logic.process_point_planning import (
    prepare_measurement_point_plan,
)
...
def start_measurements(owner):
    ...
    point_plan = prepare_measurement_point_plan(owner)
    if point_plan is None:
        return
    measurement_points, skipped_points = point_plan
