...
```bash
python3 /Users/sad/dev/xrd-analysis/src/hardware/difra/scripts/validate_container.py /path/to/container.nxs.h5
```

Examples:

```bash
python3 /Users/sad/dev/xrd-analysis/src/hardware/difra/scripts/validate_container.py /path/to/container.nxs.h5 --kind technical
python3 /Users/sad/dev/xrd-analysis/src/hardware/difra/scripts/validate_container.py /path/to/container.nxs.h5 --json
```

For a packaged executable, build:

```bash
/Users/sad/dev/xrd-analysis/src/hardware/difra/scripts/build_container_validator_executable.sh
```
