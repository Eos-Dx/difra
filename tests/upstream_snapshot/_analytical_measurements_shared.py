...
from container.v0_1 import schema, validator, writer


@pytest.fixture
def session_container_with_technical(tmp_path):
    """Create session container with technical data copied."""
    from container.v0_1.technical_container import (
...
"""
    ...
    from container.v0_1.container_manager import lock_container
