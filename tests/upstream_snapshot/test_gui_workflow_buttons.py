...
from difra.gui.main_window_ext import technical_measurements
...
def test_gui_button_driven_technical_workflow(qapp, tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "difra.gui.detector_distance_config_dialog.DetectorDistanceConfigDialog",
        _FakeDistanceDialog,
    )
    monkeypatch.setattr(technical_measurements, "PoniFileSelectionDialog", _FakePoniSelectionDialog)
    monkeypatch.setattr("difra.gui.operator_manager.OperatorManager", _FakeOperatorManager)
