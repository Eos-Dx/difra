...
if "difra.gui.technical.capture" not in sys.modules:
    cap_mod = types.ModuleType("difra.gui.technical.capture")
    ...
    sys.modules["difra.gui.technical.capture"] = cap_mod

if "difra.gui.technical.widgets" not in sys.modules:
    w_mod = types.ModuleType("difra.gui.technical.widgets")
    ...
    sys.modules["difra.gui.technical.widgets"] = w_mod

# Stub logger module
if "difra.utils.logger" not in sys.modules:
    l_mod = types.ModuleType("difra.utils.logger")
    ...
    sys.modules["difra.utils.logger"] = l_mod
...
class TestMeasurementPointFiltering(unittest.TestCase):
    ...
    @patch("difra.hardware.auxiliary.encode_image_to_base64")
